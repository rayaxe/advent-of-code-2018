...
internal class Day2Tests {
    ...
    inner class Day2Part1 {
        ...
        @Test
        fun example1() {
            assertEquals(12, day2Part1(listOf("abcdef", "bababc", "abbcde", "abcccd", "aabcdd", "abcdee", "ababab")))
        }
    }
    ...
    inner class Day2Part2 {
        ...
        @Test
        fun example1() {
            assertEquals("fgij", day2Part2(listOf("abcde", "fghij", "klmno", "pqrst", "fguij", "axcye", "wvxyz")))
        }
    }
}